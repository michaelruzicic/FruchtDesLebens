    ...
    return (
      <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
        <View style={styles.container}>
          ...
          <TouchableOpacity style={styles.createButtonEditMode} onPress={() => navigation.navigate('Deine Notizen')}><Text style={styles.createButtonText}>Speichern</Text></TouchableOpacity>
